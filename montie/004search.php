<?php
  $titlebar = "Searching &mdash; Montie Porch: a charmed life";
...
<h2>Search within the book &mdash; two methods</h2>


   <box style="float:right; width:40%;">
...
<!-- <h3>Use Freefind:</h3> -->
<!-- <p>In this box, type the word or phrase you want to find, and click Go.</p> -->
<!--    </box> -->

   <box style="float:left; width:40%;">
<h3>Find with your own browser:</h3>
<p>You need to be viewing either Section 1 or Section 2 of the book for this method.</p>
<ul>
<li>If you are using a desktop computer, do <b>Control-F</b> on your keyboard. (That is a common keystroke for Find; some systems use <b>F4</b>.) Or use the <b>menu</b>.</li>
<li><IMG SRC="/!elements/menubutton.png" alt="menubutton/png" width="27" height="27" align="right">If you are using a small screen such as a smartphone, look for a menu (smartphones often represent a menu by three horizontal bars, probably at the top right). <i>Find in page</i> will be on the menu.</li>
</ul>
<p>Enter the word or phrase you want.</p>
   </box>
